...
function redButtonClicked() {
    ...
    document.getElementById("q1-container").style.backgroundColor = "red"


}
function yellowButtonClicked() {
    // TODO: Use the setBackgroundColor() to set the background color to #EF476F (or another color of your choice)
    document.getElementById("q1-container").style.backgroundColor = "yellow"


}
function greenButtonClicked() {
    // TODO: Use the setBackgroundColor() to set the background color to #EF476F (or another color of your choice)
    document.getElementById("q1-container").style.backgroundColor = "green"


}
function lightblueButtonClicked() {
    // TODO: Use the setBackgroundColor() to set the background color to #EF476F (or another color of your choice)
    document.getElementById("q1-container").style.backgroundColor = "blue"


}
function blueButtonClicked() {
    // TODO: Use the setBackgroundColor() to set the background color to #EF476F (or another color of your choice)
    document.getElementById("q1-container").style.backgroundColor = "black"
